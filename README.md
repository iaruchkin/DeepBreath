...
App mostly for monitoring **Air Quality Index** at your current location(choose location option will be added in future udates) and additionally for **Weather Forecast**. You can download this app from **Android Market** or install it from **APK**.
